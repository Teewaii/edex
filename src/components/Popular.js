        ...
        <section className="popular bg-Popgreen mt-12 py-12 ">
            <div className="main_container flex flex-col  items-center container">
                <div className='left_info  '>
                    <h4 className=' text-green header3 mb-4 max-w-[115px] lg:max-w-[200px] leading-9 md:mb-8  md:text-5xl lg:text-4xl xl:text-[40px] lg:text-left lg:leading-[50px] lg:mb-[12px] relative'>
